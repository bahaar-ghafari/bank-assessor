...
export default function AssessorsFormsStatusPerPage(): ReactElement {
  const assessorsOption = [
    {
      label: 'بلوغ بانک را در آشنایی با تعریف و اهداف مدیریت ریسک اعتباری چه مقدار ارزیابی میکنید؟	',
      value: 1,
      status: false,
    },
    {
      label:
        'بلوغ بیانیه ریسک اعتباری و مدل های اندازه گیری ریسک اعتباری را چه مقدار ارزیابی می کنید؟	',
      value: 2,
      status: false,
    },
    {
      label:
        'بلوغ بانک در تطابق با رهنمودها و دستورالعمل های مدیریت ریسک اعتباری را چه میزان ارزیابی میکنید؟	',
      value: 3,
      status: false,
    },
    {
    ...
    {
      label:
        'بلوغ بانک در تطابق با رهنمودها و دستورالعمل های مدیریت ریسک عملیاتی را چه میزان ارزیابی میکنید؟	gg',
      value: 15,
      status: false,
    },
    {
